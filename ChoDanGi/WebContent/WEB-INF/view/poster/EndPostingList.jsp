...
<head>
<meta charset="UTF-8">
<title>EndPostingList.jsp</title>
    ...
    <div class="row">
		...
		<div class="col-md-2">
		    <div class="card mb-4">
		        ...
		        <div class="list-group">
		            ...
		            <a href="endpostinglist.action" class="list-group-item list-group-item-action active">채용 완료한 공고</a>
        ...
        <div class="col-md-10">
            ...
            <div id="completedJobs" class="card mb-4">
                <div class="card-header bg-info text-white text-center">
                    <h5 class="card-title">${loginId }님의 채용 완료<span class="text-warning">(구직자 지원)</span>한 공고</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <c:forEach var="dto" items="${endPostingList}">
                                        <tr>
                                        	<td>${dto.title }</td>
                                            <td>${dto.companyName}</td>
                                            <td>${dto.locationName}</td>
                                            <td>${dto.categoryName}</td>
                                            <td><fmt:formatNumber type="currency" value="${dto.hourlyWage }" /></td>
                                            <td>${dto.workStartTime}</td>
                                            <td>${dto.workEndTime}</td>
