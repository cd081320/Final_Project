...
<head>
<meta charset="EUC-KR">
<title>CompanyUpdateForm.jsp</title>
    ...
    <div class="row">
        ...
        <div class="col-md-10">
            ...
            <div id="editPage" class="card mb-4">
                <div class="card-header bg-info text-white text-center">
                    <h5 class="card-title mb-0">${loginId }님의 회사정보 수정</h5>
                </div>
                <div class="card-body">
                    <div class="mb-3 text-center">
                        <form action="companyupdate.action" method="post" id="submitForm">
                        	<input type="hidden" id="c_id" name="c_id" value="${company.c_id }" />
                        	<input type="hidden" id="pci_id" name="pci_id" value="${company.pci_id }" />
                        	<input type="hidden" id="pi_id" name="pi_id" value="${company.pi_id }" />
                            <div class="mb-3">
                                <span class="text-dark fw-bold">회사명</span>
                                <input type="text" id="name" name="name" class="form-control text-center" value="${company.name }"/>
                            </div>
                            <div class="mb-3 form-control">
							    <label for="sample6_postcode" class="form-label text-dark fw-bold">회사 위치</label>
							    <div class="input-group">
							        <input type="text" id="sample6_postcode" name="postaddr" class="form-control" placeholder="우편번호" readonly="readonly" value="${company.postaddr }">
							    ...
							    <input type="text" id="sample6_detailAddress" name="location" class="form-control mt-2" placeholder="상세주소" value="${company.location }">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="details" id="details" cols="10" rows="5" class="form-control">${company.details }</textarea>
                            </div>
                            <div class="mb-3">
                                <span class="text-dark fw-bold">사업자 등록 번호</span>
                                <input type="text" id="business_id" name="business_id" class="form-control text-center" value="${company.business_id}"/>
                            </div>
