...
<head>
<meta charset="UTF-8">
<title>SeekerInquiryInfo.jsp</title>
...
<script type="text/javascript">
	$(document).ready(function()
	{
		...
		{
			$(location).attr("href", "search2.action?id=" + $(this).val());
		});
	});
</script>
</head>
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
					<table class="table table-striped">
						...
						<tr>
							<td>
								<textarea name="content" id="content" class="form-control" readonly="readonly" style="height: 200px;">${search.content }</textarea>
							</td>
						</tr>
						...
						<tr>
							<td style="text-align: center;">
								<button type="submit" class="btn btn-success" value= "<%=id %>">답변</button>
								<br />
							</td>
						</tr>
