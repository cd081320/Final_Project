...
<head>
<meta charset="UTF-8">
<title>PInquiryAnswerForm.jsp</title>
	...
	<div class="panel-group">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form action="pinquiryanswer.action" method="get" id="pinquiry">
					<table class="table table-striped">
						...
						<tr>
							...
							<td>
								...
								<!-- -------------------------------------------------------------------------------- -->
									<input type="text" name="p_report_id" id="p_report_id" value ="${p_search.id }" style="display:none">
								</div>
							</td>
