...
public class PostTableDTO {
	...
	private int id;						// 공고번호
	private int p_company_info_id;		// 구인자 업체 정보 번호
	private int location_id;			// 지역번호
	private int category_id;			// 분야번호
	private int gender_id;				// 성별번호
	...
	public int getP_company_info_id() {
		return p_company_info_id;
	}
	public void setP_company_info_id(int p_company_info_id) {
		this.p_company_info_id = p_company_info_id;
	}
